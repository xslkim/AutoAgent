...
def main_ok():
    """Correct version: normal Notepad operation.

    This is a no-op script — the E2E test framework handles Notepad normally.
    """
    print("notepad_target_ok: Normal Notepad operation (no interference)")
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1 and sys.argv[1] == "broken":
        main_broken()
    else:
        main_ok()
